...
from beehive_resource.plugins.provider.entity.security_group import RuleGroup, SecurityGroup
...
class SecurityGroupTask(AbstractProviderResourceTask):
    ...
    def create_rule_group_step(task, step_id, params, availability_zone_id, *args, **kvargs):
        ...
        task.progress(step_id, msg='Create rule group %s in availability zone %s' % (group_id, availability_zone_id))
