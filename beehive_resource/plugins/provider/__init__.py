...
from beehive_resource.plugins.provider.views.logging_role_mapping import ComputeLoggingRoleMappingAPI
from beehive_resource.plugins.provider.views.monitoring_folder import ComputeMonitoringFolderAPI
from beehive_resource.plugins.provider.views.monitoring_team import ComputeMonitoringTeamAPI
from beehive_resource.plugins.provider.views.monitoring_alert import ComputeMonitoringAlertAPI
