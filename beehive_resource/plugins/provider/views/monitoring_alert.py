...
from beehive_resource.plugins.provider.entity.monitoring_alert import ComputeMonitoringAlert
...
class ListMonitoringAlerts(ProviderMonitoringAlert):
    ...
    responses = SwaggerApiView.setResponses({
        200: {
            'description': 'success',
            'schema': ListMonitoringAlertsResponseSchema
        }
    })
...
class GetMonitoringAlert(ProviderMonitoringAlert):
    ...
    responses = SwaggerApiView.setResponses({
        200: {
            'description': 'success',
            'schema': GetMonitoringAlertResponseSchema
        }
    })
...
class CreateMonitoringAlertGrafanaAlertRequestSchema(Schema):
    ...
    desc = fields.String(required=True, example='This is the test alert', default='', description='Alert description')
    email = fields.String(required=True, example='test_email@aaa.it', default='', description='Alert email')
...
class CreateMonitoringAlertParamRequestSchema(CreateProviderResourceRequestSchema):
    ...
    grafana_alert = fields.Nested(CreateMonitoringAlertGrafanaAlertRequestSchema, required=True,
