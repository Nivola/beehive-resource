...
from beehive_resource.plugins.provider.entity.monitoring_team import ComputeMonitoringTeam
...
class ListMonitoringTeams(ProviderMonitoringTeam):
    ...
    responses = SwaggerApiView.setResponses({
        200: {
            'description': 'success',
            'schema': ListMonitoringTeamsResponseSchema
        }
    })
...
class GetMonitoringTeam(ProviderMonitoringTeam):
    ...
    responses = SwaggerApiView.setResponses({
        200: {
            'description': 'success',
            'schema': GetMonitoringTeamResponseSchema
        }
    })
...
class CreateMonitoringTeamGrafanaTeamRequestSchema(Schema):
    ...
    desc = fields.String(required=True, example='This is the test team', default='', description='Team description')
...
class CreateMonitoringTeamParamRequestSchema(CreateProviderResourceRequestSchema):
    ...
    grafana_team = fields.Nested(CreateMonitoringTeamGrafanaTeamRequestSchema, required=True,
...
class SendMonitoringTeamActionParamsUserRequestSchema(Schema):
    users_email = fields.String(required=True, example='aaa@bbb.it,ccc@ddd.it', description='users email to search')


class SendMonitoringTeamActionParamsRequestSchema(Schema):
    add_user = fields.Nested(SendMonitoringTeamActionParamsUserRequestSchema, required=False, allow_none=True,
...
class ComputeMonitoringTeamAPI(ProviderAPI):
    ...
    def register_api(module, **kwargs):
        ...
        rules = [
            ...
            ('%s/monitoring_teams/<oid>/actions' % base, 'PUT', SendMonitoringTeamAction, {}),
        ]
        kwargs['version'] = 'v1.0'
