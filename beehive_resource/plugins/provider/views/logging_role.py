...
class ListLoggingRoles(ProviderLoggingRole):
    ...
    responses = SwaggerApiView.setResponses({
        200: {
            'description': 'success',
            'schema': ListLoggingRolesResponseSchema
        }
    })
...
class GetLoggingRole(ProviderLoggingRole):
    ...
    responses = SwaggerApiView.setResponses({
        200: {
            'description': 'success',
            'schema': GetLoggingRoleResponseSchema
        }
    })
...
class CreateLoggingRoleElkRoleRequestSchema(Schema):
    ...
    desc = fields.String(required=True, example='This is the test role', default='', description='Role description')
...
class CreateLoggingRoleParamRequestSchema(CreateProviderResourceRequestSchema):
    ...
    elk_role = fields.Nested(CreateLoggingRoleElkRoleRequestSchema, required=True,
