...
from beehive.common.apimanager import PaginatedResponseSchema, SwaggerApiView, \
    GetApiObjectRequestSchema, CrudApiObjectTaskResponseSchema, ApiManagerError
...
class CreateStackOracleParamsRequestSchema(Schema):
    ...
    oracle_partitioning_option = fields.String(required=False, example='Y',
                                               description='Oracle partitioning option Y/N')
    ...
    oracle_natcharset = fields.String(required=False, example='AL16UTF16',
    ...
    oracle_data_disk_size = fields.Integer(required=False, example=30, missing=None,
                                           description='Size of oracle datafiles disk')
    oracle_bck_disk_size = fields.Integer(required=False, example=20, missing=None,
                                          description='Size of oracle recovery disk')

class CreateStackPostgresqlParamsRequestSchema(Schema):
    geo_extension = fields.Bool(required=False, example=False, missing=True, allow_none=True,
...
class CreateStackParamRequestSchema(CreateProviderResourceRequestSchema):
    ...
    volume_flavor = fields.String(required=False, example='vol.default', missing='compact', description='volume size')
    ...
    db_root_password = fields.String(required=False, example='', description='The database admin password',
                                     allow_none=True)
    key_name = fields.String(required=False, example='', allow_none=True, description='Openstack public key name')
    version = fields.String(required=False, example='5.7', description='Database engine version')
    engine = fields.String(required=False, validate=OneOf(['mysql', 'postgresql', 'oracle', 'sqlserver']),
                           example='mysql', description='Database engine')
    port = fields.String(required=False, example=3306, missing=None, description='Database engine port')
    charset = fields.String(required=False, example='latin1', missing='latin1', allow_none=True,
                            description='Database charset')
    timezone = fields.String(required=False, example='Europe/Rome', missing='Europe/Rome', allow_none=True,
    ...
    host_group = fields.String(required=False, allow_none=True, example='default', description='define the optional '
                               'host group the db instance belongs to')
    customization = fields.String(required=False, example='mysql', description='id, uuid or name of the customization')
    hypervisor = fields.String(required=False, example='openstack', description='type of the hypervisor')
    csi_custom = fields.Boolean(required=False, example=False, missing=False, allow_none=True,
                                description='flag to enable post-installation CSI setup')
    replica = fields.Boolean(required=False, example=False, missing=False, allow_none=True,
                             description='enable database replica')
    replica_arch_type = fields.String(required=False, validate=OneOf(['MS', 'MM']), example='MS', allow_none=True,
                                      description='defines the method use to store data in a database replication \
                                      system, master-slave or multi-master')
    replica_role = fields.String(required=False, validate=OneOf(['M', 'S']), example='S', allow_none=True,
                                 description='defines the role of the database server in a database replication \
                                 system, master or slave')
    replica_sync_type = fields.String(required=False, validate=OneOf(['async', 'semisync']), example='async',
                                      allow_none=True, description="defines the way of writing data to the replica, \
                                      async or semisync")
    replica_master = fields.String(required=False, example='116850', allow_none=True, description='id, uuid or name \
                                   of master server in a database replication system')
    replica_username = fields.String(required=False, example='', allow_none=True, description='The user name of the \
                                     replica')
    replica_password = fields.String(required=False, example='', allow_none=True, description='Password for replica \
                                     user')
    db_monitor = fields.Boolean(required=False, default=True, description='Enable database monitoring')
    lvm_vg_data = fields.String(required=False, example='vg_data', allow_none=True, description='LVM volume group for \
                                data storage')
    lvm_vg_backup = fields.String(required=False, example='vg_backup', allow_none=True, description='LVM volume group \
                                  for backup storage')
    lvm_lv_data = fields.String(required=False, example='lv_fsdata', allow_none=True, description='LVM logical volume \
                                for data storage')
    lvm_lv_backup = fields.String(required=False, example='lv_fsbackup', allow_none=True, description='LVM logical \
                                  volume for backup storage')
    data_dir = fields.String(required=False, example='/data', allow_none=True, description='Mount point for data \
                             storage')
    backup_dir = fields.String(required=False, example='/bck', allow_none=True, description='Mount point for backup \
                               storage')
    oracle_params = fields.Nested(CreateStackOracleParamsRequestSchema, many=False, required=False,
                                  allow_none=True, description='Configure Oracle database options')
    postgresql_params = fields.Nested(CreateStackPostgresqlParamsRequestSchema, many=False, required=False,
                                  allow_none=True, description='Configure Postgres database options')
...
class UpdateStackParamRequestSchema(UpdateProviderResourceRequestSchema):
    remove_replica = fields.Boolean(required=False, example=False, missing=False, allow_none=True,
                                    description='if true, promotes a master or slave instance to a standalone DB \
                                    instance')
    replica_arch_type = fields.String(required=False, validate=OneOf(['MS', 'MM']), example='MS', missing='MS',
                                      allow_none=True, description='defines the method use to store data in a database \
                                      replication system, master-slave or multi-master')
    replica_role = fields.String(required=False, validate=OneOf(['M', 'S']), example='S', missing='S', allow_none=True,
                                 description='defines the role of the database server in a database replication \
                                 system, master or slave')
    replica_sync_type = fields.String(required=False, validate=OneOf(['async', 'semisync']), example='async',
                                      missing='async', allow_none=True, description='defines the way of writing data \
                                      to the replica, async or semisync')
    replica_master = fields.String(required=False, example='116850', missing=None, allow_none=True,
...
class ActionStackParamsCreateDbRequestSchema(Schema):
    ...
    charset = fields.String(required=False, example='latin1', allow_none=True, description='Database charset')
...
class ActionStackParamsGetUsersRequestSchema(Schema):
    ...
    privileges = fields.Dict(required=True, example='test!1234', allow_none=False, description='User privileges')
...
class ActionStackParamsCreateUserRequestSchema(Schema):
    ...
    password = fields.String(required=True, example='test!1234', allow_none=False, description='User password')
...
class ActionStackParamsGrantPrivilegesRequestSchema(Schema):
    privileges = fields.String(required=True, example='SELECT,INSERT,DELETE,UPDATE', allow_none=False,
...
class ActionStackParamsRevokePrivilegesRequestSchema(Schema):
    privileges = fields.String(required=True, example='DELETE,UPDATE', allow_none=False,
                               description='Privileges string in the format priv1,priv2,...,privN')
    db_name = fields.String(required=True, example='test', allow_none=False, description='Database name')
    usr_name = fields.String(required=True, example='test_usr', allow_none=False, description='User name')
...
class ActionStackParamsChangePasswordRequestSchema(Schema):
    name = fields.String(required=True, example='test_usr', allow_none=False, description='User name')
    new_password = fields.String(required=True, example='test!5678', allow_none=False, description='New user password')
...
class ActionStackParamsEnableMailxRequestSchema(Schema):
    relayhost = fields.String(required=False, allow_none=True, example='xxx.csi.it',
...
class ActionStackParamsHaproxyRegisterRequestSchema(Schema):
    port_ini = fields.String(required=False, allow_none=True, example='10100', description='First port number '
                             '(included) in haproxy range of ports that client can connect to')
    port_fin = fields.String(required=False, allow_none=True, example='10999', description='Last port number '
                             '(excluded) in haproxy range of ports that client can connect to')


class ActionStackParamsResizeRequestSchema(Schema):
    new_data_disk_size = fields.Integer(required=True, example=30, allow_none=False,
...
class ActionStackParamsRequestSchema(Schema):
    ...
    add_security_group = fields.Nested(ActionStackParamsSecurityGroupRequestSchema,
                                       description='Add security group to database server')
    del_security_group = fields.Nested(ActionStackParamsSecurityGroupRequestSchema,
                                       description='Remove security group from database server')
    set_flavor = fields.Nested(ActionStackParamsSetFlavorRequestSchema, description='Set flavor to database server')
    get_dbs = fields.Boolean(description='List databases')
    add_db = fields.Nested(ActionStackParamsCreateDbRequestSchema, description='Create database and schema. For '
                           'postgres use db1 to create database db1 and db1.schema1 to create schema schema1 in '
                           'database db1')
    drop_db = fields.Nested(ActionStackParamsDeleteDbRequestSchema, description='Delete database and schema. For '
    ...
    grant_privs = fields.Nested(ActionStackParamsGrantPrivilegesRequestSchema,
                                description='Assign privileges to user')
    revoke_privs = fields.Nested(ActionStackParamsRevokePrivilegesRequestSchema,
    ...
    enable_monitoring = fields.Nested(ActionStackParamsEnableMonitoringRequestSchema,
                                      description='Enable resources monitoring over sql stack')
    disable_monitoring = fields.Nested(ActionStackParamsDisableMonitoringRequestSchema,
                                       description='Disable resources monitoring over sql stack')
    enable_logging = fields.Nested(ActionStackParamsEnableLoggingRequestSchema,
                                   description='Enable log forwarding over sql stack')
    enable_mailx = fields.Nested(ActionStackParamsEnableMailxRequestSchema,
                                 description='Enable mailx over sql stack')
    haproxy_register = fields.Nested(ActionStackParamsHaproxyRegisterRequestSchema,
    ...
    resize = fields.Nested(ActionStackParamsResizeRequestSchema, description='Resize database storage capacity')
...
class ActionStackResponseSchema(Schema):
    ...
    dbs = fields.List(fields.Dict, required=False, default={}, example={}, description='sql stack database list')
    users = fields.List(fields.Dict, required=False, default={}, example={}, description='sql stack user list')
...
class ActionStack(ProviderStack):
    ...
    responses = SwaggerApiView.setResponses({
        ...
        200: {
            'description': 'success',
            'schema': ActionStackResponseSchema
        }
    })
