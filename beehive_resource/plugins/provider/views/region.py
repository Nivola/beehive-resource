...
class ListRegions(ProviderRegion):
    ...
    responses = SwaggerApiView.setResponses({
        200: {
            'description': 'success',
            'schema': ListRegionsResponseSchema
        }
    })
...
class GetRegion(ProviderRegion):
    ...
    responses = SwaggerApiView.setResponses({
        200: {
            'description': 'success',
            'schema': GetRegionResponseSchema
        }
    })
...
class CreateRegionParamRequestSchema(CreateProviderResourceRequestSchema):
    geo_area = fields.String(required=True, example='Italy',
                             description='geographic area: Italy, Europe')
    coords = fields.String(required=True, example='45.514046, 13.007813',
