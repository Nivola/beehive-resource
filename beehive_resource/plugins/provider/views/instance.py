...
class InstanceAttributesResponseSchema(Schema):
    ...
    type = fields.String(
        required=True,
        example="openstack",
        description="instance type: vsphere or openstack",
    )


class InstanceResponseSchema(ResourceResponseSchema):
    flavor = fields.Nested(
        InstanceFlavorResponseSchema,
        required=True,
        description="flavor",
        allow_none=True,
    )
    ...
    block_device_mapping = fields.Nested(
        InstanceBlockDeviceResponseSchema,
        required=True,
        many=True,
    ...
    attributes = fields.Nested(
        InstanceAttributesResponseSchema,
        required=True,
...
class ListInstances(ProviderInstance):
    ...
    responses = SwaggerApiView.setResponses({200: {"description": "success", "schema": ListInstancesResponseSchema}})
...
class GetInstance(ProviderInstance):
    ...
    responses = SwaggerApiView.setResponses({200: {"description": "success", "schema": GetInstanceResponseSchema}})
...
class CreateInstanceNetworkIpRequestSchema(Schema):
    ...
    hostname = fields.String(
        required=False,
        example="instance-vsphere01.tstsddc.csi.it",
...
class CreateInstanceNetworkRequestSchema(Schema):
    ...
    fixed_ip = fields.Nested(
        CreateInstanceNetworkIpRequestSchema,
        required=False,
        allow_none=True,
...
class CreateInstanceParamRequestSchema(CreateProviderResourceRequestSchema):
    ...
    block_device_mapping = fields.Nested(
        CreateInstanceBlockDeviceRequestSchema,
        many=True,
        required=True,
        description="list of block device",
        allow_none=True,
    )
    ...
    metadata = fields.Dict(
        required=False,
        example={"MyName": "Apache1"},
        description="custom metadata",
        missing={},
    )
    personality = fields.List(
        fields.Dict(example=[{"path": "/etc/banner.txt", "contents": "dsdsd=="}]),
        required=False,
        description="custom file to inject",
        missing=[],
    )
    ...
    check_main_vol_size = fields.Boolean(
        example=True,
        missing=True,
        required=False,
...
class GetInstanceActions(ProviderInstance):
    ...
    parameters = SwaggerHelper().get_parameters(GetApiObjectRequestSchema)
    responses = SwaggerApiView.setResponses(
        {200: {"description": "success", "schema": GetInstanceActionsResponseSchema}}
    )

    def get(self, controller, data, oid, *args, **kwargs):
        obj = self.get_resource_reference(controller, oid)
        res = obj.get_actions()
        resp = {"actions": res, "count": len(res)}
        return resp
...
class GetInstanceAction(ProviderInstance):
    ...
    responses = SwaggerApiView.setResponses(
        {200: {"description": "success", "schema": GetInstanceActionResponseSchema}}
    )
...
class SendInstanceActionParamsExtendVolumeRequestSchema(Schema):
    volume = fields.String(
        required=True,
        example="4cdf0ea4-159a-45aa-96f2-708e461130e1",
        description="volume uuid or name",
    )
    volume_size = fields.Integer(required=True, example=10, description="Size of volume in GB")
...
class SendInstanceActionParamsRequestSchema(Schema):
    ...
    del_volume = fields.Nested(
        SendInstanceActionParamsVolumeRequestSchema,
        description="remove volume from server",
    )
    extend_volume = fields.Nested(
        SendInstanceActionParamsExtendVolumeRequestSchema,
        description="extend volume of server",
    )
    set_flavor = fields.Nested(
        SendInstanceActionParamsSetFlavorRequestSchema,
    ...
    del_snapshot = fields.Nested(
        SendInstanceActionParamsSnapshotRequestSchema,
        description="remove server snapshot",
    )
    revert_snapshot = fields.Nested(
        SendInstanceActionParamsSnapshotRequestSchema,
        description="revert server to snapshot",
    )
    add_security_group = fields.Nested(
        SendInstanceActionParamsSgRequestSchema,
    ...
    set_user_pwd = fields.Nested(
        SendInstanceActionParamsSetUserPwdRequestSchema,
        description="set instance user password",
    )
    set_ssh_key = fields.Nested(
        SendInstanceActionParamsSetSshKeyRequestSchema,
        description="set instance user ssh key",
    )
    unset_ssh_key = fields.Nested(
        SendInstanceActionParamsUnsetSshKeyRequestSchema,
        description="unset instance user ssh key",
    )
    enable_monitoring = fields.Nested(
        SendInstanceActionParamsEnableMonitoringRequestSchema,
        description="enable resources monitoring over compute instance",
    )
    disable_monitoring = fields.Nested(
        SendInstanceActionParamsDisableMonitoringRequestSchema,
        description="disable resources monitoring over compute instance",
    )
    enable_logging = fields.Nested(
        SendInstanceActionParamsEnableLoggingRequestSchema,
        description="enable log forwarding over compute instance",
    )
    disable_logging = fields.Nested(
        SendInstanceActionParamsDisableLoggingRequestSchema,
        description="disable log forwarding over compute instance",
    )
    enable_log_module = fields.Nested(
        SendInstanceActionParamsEnableLogModuleRequestSchema,
        description="enable log module over compute instance",
    )
    disable_log_module = fields.Nested(
        SendInstanceActionParamsDisableLogModuleRequestSchema,
    ...
    restore_from_backup = fields.Nested(
        SendInstanceActionParamsRestoreFromBackupRequestSchema,
...
class GetInstanceConsoleResponseSchema(Schema):
    console = fields.Nested(
        GetInstanceConsoleParamsResponseSchema,
        required=True,
        many=True,
        allow_none=True,
    )
...
class GetInstanceConsole(ProviderInstance):
    ...
    parameters = SwaggerHelper().get_parameters(GetApiObjectRequestSchema)
    responses = SwaggerApiView.setResponses(
        {200: {"description": "success", "schema": GetInstanceConsoleResponseSchema}}
    )
...
class RunInstanceCommand(ProviderInstance):
    ...
    responses = SwaggerApiView.setResponses(
        {200: {"description": "success", "schema": RunInstanceCommandResponseSchema}}
    )
...
class GetInstanceDns(ProviderInstance):
    ...
    parameters = SwaggerHelper().get_parameters(GetApiObjectRequestSchema)
    responses = SwaggerApiView.setResponses({200: {"description": "success", "schema": GetInstanceDnsResponseSchema}})
...
class SetInstanceDns(ProviderInstance):
    ...
    parameters = SwaggerHelper().get_parameters(GetApiObjectRequestSchema)
    responses = SwaggerApiView.setResponses(
        {200: {"description": "success", "schema": CrudApiObjectTaskResponseSchema}}
    )
...
class GetInstanceSnapshots(ProviderInstance):
    ...
    parameters = SwaggerHelper().get_parameters(GetApiObjectRequestSchema)
    responses = SwaggerApiView.setResponses(
        {200: {"description": "success", "schema": GetInstanceSnapshotsResponseSchema}}
    )
...
class GetInstanceBackupResponseSchema(Schema):
    ...
    restore_points = fields.Nested(
        GetInstanceBackupRestorePointResponseSchema,
        required=True,
        many=True,
        allow_none=True,
    )
    restore_point_total = fields.Int(
        required=True, example=1, description="total number of restore point", allow_none=True
    )


class GetInstanceBackupRestorePointsRequestSchema(Schema):
    oid = fields.String(required=True, description="oid", context="path")
    size = fields.Int(
        required=False,
        missing=20,
        description="size",
...
class GetInstanceBackup(ProviderInstance):
    ...
    definitions = {
        "GetInstanceBackupRestorePointsRequestSchema": GetInstanceBackupRestorePointsRequestSchema,
        "GetInstanceBackupResponseSchema": GetInstanceBackupResponseSchema,
    }
    parameters = SwaggerHelper().get_parameters(GetInstanceBackupRestorePointsRequestSchema)
    parameters_schema = GetInstanceBackupRestorePointsRequestSchema
    responses = SwaggerApiView.setResponses(
        {200: {"description": "success", "schema": GetInstanceBackupResponseSchema}}
    )

    def get(self, controller, data, oid, *args, **kwargs):
        self.logger.debug("+++++ AAA - data: %s" % data)
        size = data.get("size")
        page = int(data.get("page"))

        from beehive_resource.plugins.provider.entity.instance import ComputeInstance

        computeInstance: ComputeInstance = self.get_resource_reference(controller, oid)
        res = computeInstance.get_physical_backup_status(size, page)
        return res
...
class GetInstanceBackupRestoresResponseSchema(Schema):
    restores = fields.Nested(
        GetInstanceBackupRestoreResponseSchema,
        required=True,
        many=True,
        allow_none=True,
    )
...
class GetInstanceQuotasValueResponseSchema(Schema):
...
class GetInstanceQuotasResponseSchema(Schema):
    quotas = fields.Nested(GetInstanceQuotasValueResponseSchema, required=True, many=True, allow_none=True)


class GetInstanceQuotas(ProviderInstance):
    definitions = {
        "GetInstanceQuotasResponseSchema": GetInstanceQuotasResponseSchema,
    }
    parameters = SwaggerHelper().get_parameters(GetApiObjectRequestSchema)
    responses = SwaggerApiView.setResponses(
        {200: {"description": "success", "schema": GetInstanceQuotasResponseSchema}}
    )
    ...
    def get(self, controller, data, oid, *args, **kwargs):
        ...
        """
        computeInstance: ComputeInstance = self.get_resource_reference(controller, oid)
        quotas = computeInstance.get_quotas()
...
class InstanceProviderAPI(ProviderAPI):
    ...
    def register_api(module, **kwargs):
        ...
        rules = [
            ...
            (
                "%s/instances/<oid>/backup/restore_points" % base,
                "GET",
                GetInstanceBackup,
                {},
            ),
            (
                "%s/instances/<oid>/backup/restore_points/<sid>/restores" % base,
                "GET",
                GetInstanceBackupRestores,
                {},
            ),
            ("%s/instances/<oid>/quotas" % base, "GET", GetInstanceQuotas, {}),
        ]
