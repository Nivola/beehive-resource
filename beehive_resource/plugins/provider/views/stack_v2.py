...
class ListStackV2s(ProviderStackV2):
    ...
    responses = SwaggerApiView.setResponses({
        200: {
            'description': 'success',
            'schema': ListStackV2sResponseSchema
        }
    })
...
class GetStackV2(ProviderStackV2):
    ...
    responses = SwaggerApiView.setResponses({
        200: {
            'description': 'success',
            'schema': GetStackV2ResponseSchema
        }
    })
...
class CreateStackV2ActionResourceRequestSchema(Schema):
    ...
    operation = fields.String(required=True, example='test', description='action resource operation to execute')
    preserve = fields.Bool(required=False, example=True, missing=False,
...
class CreateStackV2ActionRequestSchema(Schema):
    ...
    resource = fields.Nested(CreateStackV2ActionResourceRequestSchema, many=False, required=True,
...
class CreateStackV2ParamRequestSchema(CreateProviderResourceRequestSchema):
    ...
    inputs = fields.Nested(CreateStackV2InputRequestSchema, many=True, required=False,
                           description='list of stack inputs')
    outputs = fields.Nested(CreateStackV2OutputRequestSchema, many=True, required=True,
                            description='list of stack outputs')
    actions = fields.Nested(CreateStackV2ActionRequestSchema, many=True, required=True,
