...
from beehive.common.apimanager import PaginatedResponseSchema, SwaggerApiView, \
    GetApiObjectRequestSchema, CrudApiObjectTaskResponseSchema
...
class ListGateways(ProviderGateway):
    ...
    responses = SwaggerApiView.setResponses({
        200: {
            'description': 'success',
            'schema': ListGatewaysResponseSchema
        }
    })
...
class GetGateway(ProviderGateway):
    ...
    responses = SwaggerApiView.setResponses({
        200: {
            'description': 'success',
            'schema': GetGatewayResponseSchema
        }
    })
...
class CreateGatewayParamRequestSchema(CreateProviderResourceRequestSchema):
    ...
    primary_ip_address = fields.String(required=False, example='10.101.2.3', missing=None,
                                       description='primary zone uplink ip address')
    secondary_ip_address = fields.String(required=False, example='10.101.2.4', missing=None,
    ...
    flavor = fields.String(required=False, example='compact', missing='compact',
                           description='gateway size. Can be compact, large, quadlarge, xlarge.')
    volume_flavor = fields.String(required=False, example='vol.default', missing='compact', description='gateway size')
    type = fields.String(required=False, example='vsphere', missing='vsphere', description='orchestrator type')
...
class SetGatewayDefaultRouteRequestSchema(Schema):
    role = fields.String(required=False, example='default', missing='default',
...
class AddGatewayNatRuleRequestSchema(Schema):
    role = fields.String(required=False, example='default', missing='primary',
...
class GetGatewayNatRule(ProviderGateway):
    ...
    responses = SwaggerApiView.setResponses({
        200: {
            'description': 'success',
            'schema': GetGatewayNatRuleResponseSchema
        }
    })
...
class AddGatewayFirewallRuleRequestSchema(Schema):
    role = fields.String(required=False, example='default', missing='default',
                         ...
                         validate=OneOf(['default', 'primary', 'secondary']))
    action = fields.String(required=False, example='accept', missing='accept', description='can be accept, deny',
                           validate=OneOf(['accept', 'deny']))
    enabled = fields.Boolean(required=False, example=True, missing=True, description='rule status')
    logged = fields.Boolean(required=False, example=False, missing=False, description='rule logged')
    direction = fields.String(required=False, example='inout', missing=None,
                              description='rule direction. Can be: in, out, inout')
    source = fields.String(required=False, example='ip:<ipAddress>', missing=None,
                           description='rule source. list of comma separated item like: ip:<ipAddress>, '
                                       'grp:<groupingObjectId>, vnic:<vnicGroupId>')
    dest = fields.String(required=False, example='ip:<ipAddress>', missing=None,
                         description='rule destination. list of comma separated item like: ip:<ipAddress>, '
                                     'grp:<groupingObjectId>, vnic:<vnicGroupId>')
    appl = fields.String(required=False, example='ser:proto+port+source_port', missing=None,
                         description='rule application. list of comma separated item like: app:<applicationId>, '
                                     'ser:proto+port+source_port')


class AddGatewayFirewallRuleRequestSchema(Schema):
    firewall_rule = fields.Nested(AddGatewayFirewallRuleRequestSchema, required=True,
...
class DelGatewayFirewallRuleRequestSchema(Schema):
    role = fields.String(required=False, example='default', missing='default',
                         description='set role to use when create firewall rule',
                         validate=OneOf(['default', 'primary', 'secondary']))
    action = fields.String(required=False, example='accept', missing=None, description='can be accept, deny',
                           validate=OneOf(['accept', 'deny']))
    direction = fields.String(required=False, example='inout', missing=None,
                              description='rule direction. Can be: in, out, inout')
    source = fields.String(required=False, example='ip:<ipAddress>', missing=None,
...
class DelGatewayFirewallRuleRequestSchema(Schema):
    firewall_rule = fields.Nested(DelGatewayFirewallRuleRequestSchema, required=True,
                                  description='firewall rule definition')
...
class GetGatewayBastion(ProviderGateway):
    ...
    responses = SwaggerApiView.setResponses({
        200: {
            'description': 'success',
            'schema': GetGatewayBastionResponseSchema
        }
    })
...
class GatewayProviderAPI(ProviderAPI):
    ...
    def register_api(module, **kwargs):
        ...
        rules = [
            ...
            # route
            ('%s/gateways/<oid>/route/default' % base, 'PUT', SetGatewayDefaultRoute, {}),
