...
class ListLoggingSpaces(ProviderLoggingSpace):
    ...
    responses = SwaggerApiView.setResponses({
        200: {
            'description': 'success',
            'schema': ListLoggingSpacesResponseSchema
        }
    })
...
class GetLoggingSpace(ProviderLoggingSpace):
    ...
    responses = SwaggerApiView.setResponses({
        200: {
            'description': 'success',
            'schema': GetLoggingSpaceResponseSchema
        }
    })
...
class CreateLoggingSpaceElkSpaceRequestSchema(Schema):
    ...
    desc = fields.String(required=True, example='This is the test space', default='', description='Space description')
...
class CreateLoggingSpaceParamRequestSchema(CreateProviderResourceRequestSchema):
    ...
    elk_space = fields.Nested(CreateLoggingSpaceElkSpaceRequestSchema, required=True,
...
class SendLoggingSpaceActionParamsDashboardRequestSchema(Schema):
    space_id_from = fields.String(required=False, allow_none=True, example='default',
    ...
    index_pattern = fields.String(required=False, example='index_pattern',
                                  description='index_pattern to replace in dashboard')


class SendLoggingSpaceActionParamsRequestSchema(Schema):
    add_dashboard = fields.Nested(SendLoggingSpaceActionParamsDashboardRequestSchema,
...
class SendLoggingSpaceActionRequestSchema(Schema):
    ...
    schedule = fields.Dict(required=False, missing=None,
...
class ComputeLoggingSpaceAPI(ProviderAPI):
    ...
    def register_api(module, **kwargs):
        ...
        rules = [
            ...
            ('%s/logging_spaces/<oid>/actions' % base, 'PUT', SendLoggingSpaceAction, {}),
        ]
        kwargs['version'] = 'v1.0'
