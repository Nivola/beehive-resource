...
from beehive_resource.plugins.provider.entity.logging_role_mapping import ComputeLoggingRoleMapping
...
class GetLoggingRoleMapping(ProviderLoggingRoleMapping):
    ...
    responses = SwaggerApiView.setResponses({
        200: {
            'description': 'success',
            'schema': GetLoggingRoleMappingResponseSchema
        }
    })
...
class CreateLoggingRoleMappingElkRoleMappingRequestSchema(Schema):
    ...
    desc = fields.String(required=True, example='This is the test role_mapping', default='', description='RoleMapping description')
...
class CreateLoggingRoleMappingParamRequestSchema(CreateProviderResourceRequestSchema):
    ...
    elk_role_mapping = fields.Nested(CreateLoggingRoleMappingElkRoleMappingRequestSchema, required=True,
...
class ComputeLoggingRoleMappingAPI(ProviderAPI):
    ...
    def register_api(module, **kwargs):
        ...
        rules = [
            ...
            ('%s/logging_role_mappings/<oid>' % base, 'DELETE', DeleteLoggingRoleMapping, {}),
        ]
