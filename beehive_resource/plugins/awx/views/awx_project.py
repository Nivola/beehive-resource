...
class ListAwxProjects(AwxProjectView):
    ...
    responses = SwaggerApiView.setResponses({
        200: {
            'description': 'success',
            'schema': ListAwxProjectsResponseSchema
        }
    })
...
class GetAwxProject(AwxProjectView):
    ...
    responses = SwaggerApiView.setResponses({
        200: {
            'description': 'success',
            'schema': GetAwxProjectResponseSchema
        }
    })
...
class CreateAwxProjectParamRequestSchema(CreateProviderResourceRequestSchema):
    ...
    scm_branch = fields.String(example='1.6.0', default='master',
                               description='Specific branch, tag or commit to checkout')
    scm_update_on_launch = fields.Boolean(default='False',
...
class UpdateAwxProjectParamRequestSchema(UpdateProviderResourceRequestSchema):
    projects = fields.Nested(UpdateAwxProjectTemplateRequestSchema, required=False, many=True,
                             description='list of orchestrator projects to link', allow_none=True)
