...
class ListAwxAdHocCommandsResponseSchema(PaginatedResponseSchema):
    ad_hoc_command = fields.Nested(ListAwxAdHocCommandsParamsResponseSchema, many=True, required=True, allow_none=True)
...
class ListAwxAdHocCommands(AwxAdHocCommandView):
    ...
    responses = SwaggerApiView.setResponses({
        200: {
            'description': 'success',
            'schema': ListAwxAdHocCommandsResponseSchema
        }
    })
...
class GetAwxAdHocCommand(AwxAdHocCommandView):
    ...
    responses = SwaggerApiView.setResponses({
        200: {
            'description': 'success',
            'schema': GetAwxAdHocCommandResponseSchema
        }
    })
...
class CreateAwxAdHocCommandParamRequestSchema(CreateProviderResourceRequestSchema):
    ...
    ssh_creds = fields.Nested(AwxAdHocCommandHostSshCredsRequestSchema, required=False, description='Ssh credentials')
    ...
    hosts = fields.Nested(AwxAdHocCommandHostRequestSchema, required=False, many=True, allow_none=True,
...
class UpdateAwxAdHocCommandParamRequestSchema(UpdateProviderResourceRequestSchema):
    ad_hoc_command = fields.Nested(UpdateAwxAdHocCommandTemplateRequestSchema, required=False, many=True,
                                   description='list of orchestrator ad_hoc_command to link', allow_none=True)
