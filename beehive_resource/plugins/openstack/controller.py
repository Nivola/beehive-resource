    ...
    **connection syntax**:
    ...
    def ping(self):
        ...
        try:
            ...
            self.__new_connection(project=project_name, timeout=30)
            res = True
        except:
            res = False
    ...
    def __get_connection_project(self, projectid):
        ...
        if projectid is not None:
            try:
                ...
                raise ApiManagerError("Openstack project %s not found" % projectid, code=404, prefix="Openstack")
    ...
    def __new_connection(self, project, timeout=None):
        ...
        try:
            ...
            with self.lock:
                ...
                self.logger.debug(
                    "+++++ Create openstack connection %s for project %s with token: %s"
                    % (openstackManager, project, token)
                )
            ...
            raise ApiManagerError(ex, code=400, prefix="Openstack")
