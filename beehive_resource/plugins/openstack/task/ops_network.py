...
def network_create_entity(self, options):
    ...
    **Return:**
    ...
    # create openstack network
    inst = conn.network.create(name, parent_ext_id, physical_network, shared, 
                               qos_policy_id, external, segments, 
...
def network_update_entity(self, options):
    ...
    **Return:**
    ...
    if ext_id is not None:
        conn.network.update(ext_id, name, shared, qos_policy_id, 
                                   external, segments)
