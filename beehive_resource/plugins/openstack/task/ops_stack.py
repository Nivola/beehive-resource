...
def task_create_stack(self, options):
    ...
    # create new stack
    stack = conn.heat.stack.create(stack_name=name, template=template, environment=environment, parameters=parameters,
                                   tags=tags, files=files, stack_owner=stack_owner)
    stack_id = stack['id']
