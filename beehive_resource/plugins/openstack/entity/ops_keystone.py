...
class OpenstackKeystone(OpenstackResource):
    ...
    def api(self):
        ...
        try:           
            ...
            err = 'Can not get openstack %s keystone api version: %s' % (self.container.name, ex)
    ...
    def get_roles(self, name=None):
        ...
        try:
            ...
            err = 'Can not get openstack %s keystone roles: %s' % (self.container.name, ex)
            self.logger.error(err, exc_info=True)
            raise ApiManagerError(err, code=400)
    ...
    def get_groups(self):
        ...
        try:           
            ...
            err = 'Can not get openstack %s keystone groups: %s' % (self.container.name, ex)
            self.logger.error(err, exc_info=True)
            raise ApiManagerError(err, code=400)
    ...
    def get_policies(self):
        ...
        try:           
            ...
            err = 'Can not get openstack %s keystone policies: %s' % (self.container.name, ex)
            self.logger.error(err, exc_info=True)
            raise ApiManagerError(err, code=400)
    ...
    def get_credentials(self):
        ...
        try:
            ...
            err = 'Can not get openstack %s keystone credentials: %s' % (self.container.name, ex)
            self.logger.error(err, exc_info=True)
            raise ApiManagerError(err, code=400)
