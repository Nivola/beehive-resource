...
class OpenstackSystem(OpenstackResource):
    ...
    def get_compute_services(self):
        ...
        try:
            ...
            err = 'Can not get openstack %s compute services: %s' % (self.container.name, ex)
            self.logger.error(err, exc_info=True)
            raise ApiManagerError(err, code=400)
    ...
    def get_compute_zones(self):
        ...
        try:
            ...
            err = 'Can not get openstack %s availability zones: %s' % (self.container.name, ex)
            self.logger.error(err, exc_info=True)
            raise ApiManagerError(err, code=400)
    ...
    def get_compute_server_groups(self):
        ...
        try:
            ...
            err = 'Can not get openstack %s server groups: %s' % (self.container.name, ex)
            self.logger.error(err, exc_info=True)
            raise ApiManagerError(err, code=400)        
    ...
    def get_compute_hypervisors_statistics(self):
        ...
        try:
            ...
            err = 'Can not get openstack %s hypervisors statistics: %s' % (self.container.name, ex)
            self.logger.error(err, exc_info=True)
            raise ApiManagerError(err, code=400)
    ...
    def get_storage_services(self):
        ...
        try:
            ...
            err = 'Can not get openstack %s storage services' % (self.container.name, ex)
            self.logger.error(err, exc_info=True)
            raise ApiManagerError(err, code=400)
    ...
    def get_network_agents(self):
        ...
        try:
            ...
            err = 'Can not get openstack %s network agents' % (self.container.name, ex)
            self.logger.error(err, exc_info=True)
            raise ApiManagerError(err, code=400)
    ...
    def get_network_service_providers(self):
        ...
        try:
            ...
            err = 'Can not get openstack %s service providers' % (self.container.name, ex)
            self.logger.error(err, exc_info=True)
            raise ApiManagerError(err, code=400)        
    ...
    def get_default_quotas(self):
        ...
        try:
            ...
            err = 'Can not get openstack default project quotas' % (self.container.name, ex)
            self.logger.error(err, exc_info=True)
            raise ApiManagerError(err, code=400)
