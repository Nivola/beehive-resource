...
class CreateSecurityGroupsRuleParamRequestSchema(Schema):
    direction = fields.String(required=True, default='ingress',
        example='ingress', description='ingress or egress')
    ethertype = fields.String(required=True, default='IPv4', example='IPv4',
        description='Must be IPv4 or IPv6')
    port_range_min = fields.String(required=False, example='9000',
        ...
        'the protocol is ICMP, this value must be an ICMP type', allow_none=True)
    port_range_max = fields.String(required=False, example='9010',
        ...
        'must be an ICMP type', allow_none=True)
    protocol = fields.String(required=False, example='tcp',
        description='The protocol that is matched by the security group rule. '\
        'Valid values are null, tcp, udp, and icmp', allow_none=True)
    remote_group_id = fields.String(required=False, example='12',
        ...
        'remote_ip_prefix attribute in the request body', allow_none=True)
    remote_ip_prefix = fields.String(required=False, example='12',
        ...
        'prefix as the source IP address of the IP packet', allow_none=True)
...
class DeleteSecurityGroupsRuleParamRequestSchema(Schema):
    rule_id = fields.String(required=False, default='12', example='12',
                            description='Security griup rule opensatck id')


class DeleteSecurityGroupsRuleRequestSchema(Schema):
    security_group_rule = fields.Nested(
        DeleteSecurityGroupsRuleParamRequestSchema, required=False)
...
class OpenstackSecurityGroupAPI(OpenstackAPI):
    ...
    def register_api(module, **kwargs):
        ...
        rules = [
            ...
            ('%s/security_groups/<oid>/reset' % base, 'DELETE', ResetSecurityGroups, {}),
            ('%s/security_groups/<oid>/rules' % base, 'POST', CreateSecurityGroupsRule, {}),
            ('%s/security_groups/<oid>/rules' % base, 'DELETE', DeleteSecurityGroupsRule, {}),
        ]
