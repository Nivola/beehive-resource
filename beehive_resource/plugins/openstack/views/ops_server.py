...
class ListOpsServers(OpenstackOpsServerApiView):
    ...
    responses = SwaggerApiView.setResponses({200: {"description": "success", "schema": ListOpsServersResponseSchema}})
...
class GetOpsServer(OpenstackOpsServerApiView):
    ...
    responses = SwaggerApiView.setResponses({200: {"description": "success", "schema": GetOpsServerResponseSchema}})
...
class OpsServerNetworkFixedIpRequestSchema(Schema):
    ...
    dns = fields.String(
        required=False,
        example="10.10.0.3,10.10.0.4",
        description="comma separated list of dns",
    )
...
class OpsServerNetworkRequestSchema(Schema):
    ...
    fixed_ip = fields.Nested(
        OpsServerNetworkFixedIpRequestSchema,
        required=False,
...
class OpsServerVolumeRequestSchema(Schema):
    ...
    destination_type = fields.String(
        required=False,
        example="volume",
        description="Defines where the volume comes " "from. A valid value is local or volume. [default=volume]",
    )
    tag = fields.String(
        example="default",
        missing="default",
    ...
    volume_type = fields.String(
        example="default",
        missing=None,
        description="The device volume_type. This can be "
...
class CreateOpsServerParamRequestSchema(Schema):
    ...
    personality = fields.List(
        fields.Dict(example=[{"path": "/etc/banner.txt", "contents": "udsdsd=="}]),
        required=False,
        missing=[],
    ...
    block_device_mapping_v2 = fields.Nested(
        OpsServerVolumeRequestSchema,
        required=False,
        many=True,
        allow_none=True,
        description="Enables fine grained control of the block device mapping " "for an instance",
    )
    config_drive = fields.Boolean(
        example=True,
        default=True,
        missing=True,
...
class DeleteOpsServerRequestSchema(Schema):
    all = fields.Boolean(
        ...
        default=True,
        context="query",
        description="If True delete all the server " "attached volumes. If False delete only boot volume",
    )
...
class GetOpsServerConsole(OpenstackOpsServerApiView):
    ...
    parameters = SwaggerHelper().get_parameters(GetApiObjectRequestSchema)
    responses = SwaggerApiView.setResponses(
        {200: {"description": "success", "schema": GetOpsServerConsoleResponseSchema}}
    )
...
class GetOpsServerNetworks(OpenstackOpsServerApiView):
    ...
    parameters = SwaggerHelper().get_parameters(GetApiObjectRequestSchema)
    responses = SwaggerApiView.setResponses(
        {200: {"description": "success", "schema": GetOpsServerNetworksResponseSchema}}
    )
...
class GetOpsServerVolumesResponseSchema(Schema):
    server_volumes = fields.Nested(
        GetOpsServerVolumesParamsResponseSchema,
        required=True,
        many=True,
        allow_none=True,
    )
...
class GetOpsServerVolumes(OpenstackOpsServerApiView):
    ...
    parameters = SwaggerHelper().get_parameters(GetApiObjectRequestSchema)
    responses = SwaggerApiView.setResponses(
        {200: {"description": "success", "schema": GetOpsServerVolumesResponseSchema}}
    )
...
class GetOpsServerRuntimeHostResponseSchema(Schema):
    id = fields.String(
        required=True,
        example="0b6fd70fc49154b1a640a201717c959efb97ad449fd2cea2c6420988",
    )
...
class GetOpsServerRuntimeResponseSchema(Schema):
    server_runtime = fields.Nested(
        GetOpsServerRuntimeParamsResponseSchema,
        required=True,
        many=True,
        allow_none=True,
    )
...
class GetOpsServerRuntime(OpenstackOpsServerApiView):
    ...
    parameters = SwaggerHelper().get_parameters(GetApiObjectRequestSchema)
    responses = SwaggerApiView.setResponses(
        {200: {"description": "success", "schema": GetOpsServerRuntimeResponseSchema}}
    )
...
class GetOpsServerStats(OpenstackOpsServerApiView):
    ...
    parameters = SwaggerHelper().get_parameters(GetApiObjectRequestSchema)
    responses = SwaggerApiView.setResponses(
        {200: {"description": "success", "schema": GetOpsServerStatsResponseSchema}}
    )
...
class GetOpsServerMetadata(OpenstackOpsServerApiView):
    ...
    parameters = SwaggerHelper().get_parameters(GetApiObjectRequestSchema)
    responses = SwaggerApiView.setResponses(
        {200: {"description": "success", "schema": GetOpsServerMetadataResponseSchema}}
    )
...
class GetOpsServerActions(OpenstackOpsServerApiView):
    ...
    parameters = SwaggerHelper().get_parameters(GetApiObjectRequestSchema)
    responses = SwaggerApiView.setResponses(
        {200: {"description": "success", "schema": GetOpsServerActionsResponseSchema}}
    )
...
class GetOpsServerAction(OpenstackOpsServerApiView):
    ...
    responses = SwaggerApiView.setResponses(
        {200: {"description": "success", "schema": GetOpsServerActionResponseSchema}}
    )
...
class SendOpsServerActionParamsExtendVolumeRequestSchema(Schema):
    volume = fields.String(
        required=True,
        example="4cdf0ea4-159a-45aa-96f2-708e461130e1",
...
class SendOpsServerActionParamsRequestSchema(Schema):
    ...
    add_security_group = fields.Nested(
        SendServerActionParamsSgRequestSchema,
    ...
    del_volume = fields.Nested(
        SendOpsServerActionParamsVolumeRequestSchema,
        description="remove volume from server",
    )
    extend_volume = fields.Nested(
        SendOpsServerActionParamsExtendVolumeRequestSchema,
        description="extend volume of server",
    )
    set_flavor = fields.Nested(
        SendOpsServerActionParamsSetFlavorRequestSchema,
    ...
    del_snapshot = fields.Nested(
        SendServerActionParamsSnapshotRequestSchema,
    ...
    restore_from_backup = fields.Nested(
        SendServerActionParamsRestoreFromBackupRequestSchema,
...
class GetOpsServerSnapshots(OpenstackOpsServerApiView):
    ...
    parameters = SwaggerHelper().get_parameters(GetApiObjectRequestSchema)
    responses = SwaggerApiView.setResponses(
        {200: {"description": "success", "schema": GetOpsServerSnapshotsResponseSchema}}
    )
...
class GetOpsServerSecurityGroups(OpenstackOpsServerApiView):
    ...
    def get(self, controller, data, oid, *args, **kwargs):
        ...
        resp = {"server_security_groups": [sg.info() for sg in res], "count": len(res)}
        return resp
...
class OpenstackServerAPI(OpenstackAPI):
    ...
    def register_api(module, **kwargs):
        ...
        rules = [
            ...
            (
                "%s/servers/<oid>/security_groups" % base,
                "GET",
                GetOpsServerSecurityGroups,
                {},
            ),
