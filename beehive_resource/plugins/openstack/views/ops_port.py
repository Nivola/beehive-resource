...
class ListPorts(OpenstackPortApiView):
    ...
    responses = SwaggerApiView.setResponses({200: {"description": "success", "schema": ListPortsResponseSchema}})
...
class GetPort(OpenstackPortApiView):
    ...
    responses = SwaggerApiView.setResponses({200: {"description": "success", "schema": GetPortResponseSchema}})
...
class CreatePortParamRequestSchema(Schema):
    ...
    fixed_ips = fields.Nested(
        CreatePortFixedIpRequestSchema,
        required=True,
        many=True,
        default=[],
    ...
    device_id = fields.String(
        default="",
        example="a0304c3a-4f08-4c43-88af-d796509c97d2",
        description="The id or uuid of the device that uses this port. For example, a virtual " "server.",
    )
    security_groups = fields.List(
        fields.String(example="a0304c3a-4f08-4c43-88af-d796509c97d2"),
        default=[],
