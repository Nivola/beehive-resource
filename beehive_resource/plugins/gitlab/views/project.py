...
class CreateProjectParamRequestSchema(Schema):
    ...
    status = fields.Integer(required=False, default=0,
                            ...
                            validate=OneOf([0, 1]))
    interfaces = fields.Nested(ProjectInterfaceRequestSchema, required=True, many=True, allow_none=True,
                               description='interfaces to be created for the project')
    projects = fields.List(fields.String(required=True, example='[\'50\', \'62\']', many=True, allow_none=True,
