...
class ListRecordCname(DnsRecordCnameApiView):
    ...
    responses = SwaggerApiView.setResponses({200: {"description": "success", "schema": ListRecordCnameResponseSchema}})
...
class GetRecordCname(DnsRecordCnameApiView):
    ...
    responses = SwaggerApiView.setResponses({200: {"description": "success", "schema": GetRecordCnameResponseSchema}})
