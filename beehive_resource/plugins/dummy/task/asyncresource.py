...
@job(entity_class=DummyAsyncResource, name="insert", delta=1)
...
@task_manager.task(bind=True, base=ResourceJob)
@job(entity_class=DummyAsyncResource, name="update", delta=1)
...
@task_manager.task(bind=True, base=ResourceJob)
@job(entity_class=DummyAsyncResource, name="delete", delta=1)
