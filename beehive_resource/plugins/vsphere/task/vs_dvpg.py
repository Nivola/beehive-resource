...
from beehive_resource.tasks import ResourceJobTask, ResourceJob, \
    create_resource_post, create_resource_pre, expunge_resource_post, \
    expunge_resource_pre, update_resource_post, update_resource_pre
...
def dvpg_create_entity(self, options):
    ...
    **Returns:**
    ...
    # create vsphere network
    task = conn.network.create_distributed_port_group(name, desc, 
                                                      segmentation_id, 
                                                      dvs_ext, numports)
