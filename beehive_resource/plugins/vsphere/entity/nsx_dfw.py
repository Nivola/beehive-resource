...
class NsxDfw(NsxResource):
    ...
    def discover_new(container, ext_id, res_ext_ids):
        ...
        items.append(('%s-dfw' % nsx_manager['hostName'], '%s Dfw' % nsx_manager['applianceName'], 
                      nsx_manager_id, None))
    ...
    def get_config(self):
        ...
        try:
            ...
            conf['layer2Sections'] = self.__get_section(
                conf.pop('layer2Sections'))
            conf['layer3RedirectSections'] = self.__get_section(
                conf.pop('layer3RedirectSections'))
            conf['layer3Sections'] = self.__get_section(
                conf.pop('layer3Sections'))
