...
from beehive_resource.plugins.vsphere.views import VsphereAPI,\
    VsphereApiView
from flasgger import fields, Schema
from beecell.swagger import SwaggerHelper
from beehive.common.apimanager import SwaggerApiView, ApiManagerError, CrudApiJobResponseSchema
...
class ServiceResponseSchema(Schema):
    ...
    name = fields.String(required=True,
                         example='OC4J Forms / Reports Instance (8889)')
...
class GetDfwConfig(NsxDfwApiView):
    ...
    responses = SwaggerApiView.setResponses({
        200: {
            'description': 'success',
            'schema': GetDfwConfigResponseSchema
        }
    })
...
class CreateDfwSectionParamRequestSchema(Schema):
    ...
    action = fields.String(required=False, example='allow', default='allow',
...
class GetDfwRule(NsxDfwApiView):
    ...
    responses = SwaggerApiView.setResponses({
        200: {
            'description': 'success',
            'schema': GetDfwRuleResponseSchema
        }
    })
...
class UpdateDfwRuleParamRequestSchema(Schema):
    ...
    ruleafter = fields.String(required=False, example=1024,
                               description='rule id, put rule after this. Use with move=True')
    name = fields.String(required=False, example='prova_section-rule-01',
                         description='rule name. Use with move=False')
    action = fields.String(required=False, example='allow',
                           description='action value. Ie: allow, deny, reject. Use with move=False')
    disable = fields.Boolean(required=False, example=True,
                             description='True if rule is disabled. Use with move=False')
    move = fields.Boolean(required=False, example=True,
...
class GetDfwExclusionList(NsxDfwApiView):
    ...
    responses = SwaggerApiView.setResponses({
        200: {
            'description': 'success',
            'schema': GetDfwExclusionListResponseSchema
        }
    })
...
class GetDfwServiceList(NsxDfwApiView):
    ...
    responses = SwaggerApiView.setResponses({
        200: {
            'description': 'success',
            'schema': GetDfwServiceListResponseSchema
        }
    })
...
class GetDfwServiceRequestSchema(GetContainerRequestSchema):
    ...
    ports = fields.String(required=True, context='path', allow_none=True,
...
class GetDfwService(NsxDfwApiView):
    ...
    responses = SwaggerApiView.setResponses({
        200: {
            'description': 'success',
            'schema': GetDfwServiceResponseSchema
        }
    })
...
class CreateDfwServiceParamRequestSchema(Schema):
    ...
    ports = fields.String(required=True, example='80, 8080, 7200, 7210, 7269, 7270, 7575, 9000-9100', allow_none=True)
...
class CreateDfwService(NsxDfwApiView):
    ...
    responses = SwaggerApiView.setResponses({
        200: {
            'description': 'success',
            'schema': CreateDfwServiceResponseSchema
        }
    })
