...
class CreateVolumeParamRequestSchema(Schema):
    ...
    volume_type = fields.String(required=False, missing=None, description='The volume type. To create an environment '
                                'with multiple-storage back ends, you must specify a volume type.')
    metadata = fields.Dict(required=False, missing={}, description='One or more metadata key and value pairs that '
