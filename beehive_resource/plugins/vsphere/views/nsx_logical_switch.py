...
class ListNsxLogicalSwitchs(VsphereNsxLogicalSwitchApiView):
    ...
    responses = SwaggerApiView.setResponses({
        200: {
            'description': 'success',
            'schema': ListNsxLogicalSwitchsResponseSchema
        }
    })
...
class GetNsxLogicalSwitch(VsphereNsxLogicalSwitchApiView):
    ...
    responses = SwaggerApiView.setResponses({
        200: {
            'description': 'success',
            'schema': GetNsxLogicalSwitchResponseSchema
        }
    })
...
class CreateNsxLogicalSwitchParamRequestSchema(Schema):
    ...
    tenant = fields.String(required=False, example='virtual wire tenant', missing='virtual wire tenant',
                           description='tenant')
...
class VsphereNsxLogicalSwitchAPI(VsphereAPI):
    ...
    def register_api(module, **kwargs):
        ...
        rules = [
            ...
            ('%s/nsx_logical_switchs/<oid>' % base, 'DELETE', DeleteNsxLogicalSwitch, {}),
        ]
