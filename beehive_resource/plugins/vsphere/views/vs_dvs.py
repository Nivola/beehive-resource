...
class GetDvsRuntime(VsphereApiView):
    ...
    responses = SwaggerApiView.setResponses({
        200: {
            'description': 'success',
            'schema': GetDvsRuntimeResponseSchema
        }
    })
...
class GetDvsPortgroupItemResponseSchema(Schema):
    ...
    portKeys = fields.List(fields.String, required=True,
...
class GetDvsPortgroup(VsphereApiView):
    ...
    responses = SwaggerApiView.setResponses({
        200: {
            'description': 'success',
            'schema': GetDvsPortgroupResponseSchema
        }
    })
