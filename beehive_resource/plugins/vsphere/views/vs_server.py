...
class ListServers(VsphereServerApiView):
    ...
    responses = SwaggerApiView.setResponses({200: {"description": "success", "schema": ListServersResponseSchema}})
...
class GetServer(VsphereServerApiView):
    ...
    responses = SwaggerApiView.setResponses({200: {"description": "success", "schema": GetServerResponseSchema}})
...
class ServerNetworkRequestSchema(Schema):
    ...
    subnet_pool = fields.String(
        required=False,
        example="ipaddresspool-3",
        description="nsx subnet pool id",
        allow_none=True,
    )
    fixed_ip = fields.Nested(
        ServerNetworkFixedIpRequestSchema,
        required=False,
...
class CreateServerParamRequestSchema(Schema):
    ...
    personality = fields.List(
        ...
        required=False,
        default=[],
        description="The file path and contents, text only, "
...
class GetServerHardware(VsphereServerApiView):
    ...
    parameters = SwaggerHelper().get_parameters(GetApiObjectRequestSchema)
    responses = SwaggerApiView.setResponses(
        {200: {"description": "success", "schema": GetServerHardwareResponseSchema}}
    )
...
class GetServerConsole(VsphereServerApiView):
    ...
    parameters = SwaggerHelper().get_parameters(GetApiObjectRequestSchema)
    responses = SwaggerApiView.setResponses({200: {"description": "success", "schema": GetServerConsoleResponseSchema}})
...
class GetServerNetworks(VsphereServerApiView):
    ...
    parameters = SwaggerHelper().get_parameters(GetApiObjectRequestSchema)
    responses = SwaggerApiView.setResponses(
        {200: {"description": "success", "schema": GetServerNetworksResponseSchema}}
    )
...
class GetServerVolumes(VsphereServerApiView):
    ...
    parameters = SwaggerHelper().get_parameters(GetApiObjectRequestSchema)
    responses = SwaggerApiView.setResponses({200: {"description": "success", "schema": GetServerVolumesResponseSchema}})
...
class GetServerRuntime(VsphereServerApiView):
    ...
    parameters = SwaggerHelper().get_parameters(GetApiObjectRequestSchema)
    responses = SwaggerApiView.setResponses({200: {"description": "success", "schema": GetServerRuntimeResponseSchema}})
...
class GetServerStats(VsphereServerApiView):
    ...
    parameters = SwaggerHelper().get_parameters(GetApiObjectRequestSchema)
    responses = SwaggerApiView.setResponses({200: {"description": "success", "schema": GetServerStatsResponseSchema}})
...
class GetServerGuest(VsphereServerApiView):
    ...
    parameters = SwaggerHelper().get_parameters(GetApiObjectRequestSchema)
    responses = SwaggerApiView.setResponses({200: {"description": "success", "schema": GetServerGuestResponseSchema}})
...
class GetServerMetadata(VsphereServerApiView):
    ...
    parameters = SwaggerHelper().get_parameters(GetApiObjectRequestSchema)
    responses = SwaggerApiView.setResponses(
        {200: {"description": "success", "schema": GetServerMetadataResponseSchema}}
    )
...
class GetServerActions(VsphereServerApiView):
    ...
    parameters = SwaggerHelper().get_parameters(GetApiObjectRequestSchema)
    responses = SwaggerApiView.setResponses({200: {"description": "success", "schema": GetServerActionsResponseSchema}})
...
class GetServerAction(VsphereServerApiView):
    ...
    responses = SwaggerApiView.setResponses({200: {"description": "success", "schema": GetServerActionResponseSchema}})
...
class SendServerActionParamsExtendVolumeRequestSchema(Schema):
    volume = fields.String(
        required=True,
        example="4cdf0ea4-159a-45aa-96f2-708e461130e1",
        description="security group uuid",
...
class SendServerActionParamsRequestSchema(Schema):
    ...
    del_volume = fields.Nested(
        SendServerActionParamsVolumeRequestSchema,
        description="remove volume from server",
    )
    extend_volume = fields.Nested(
        SendServerActionParamsExtendVolumeRequestSchema,
...
class GetServerSnapshots(VsphereServerApiView):
    ...
    parameters = SwaggerHelper().get_parameters(GetApiObjectRequestSchema)
    responses = SwaggerApiView.setResponses(
        {200: {"description": "success", "schema": GetServerSnapshotsResponseSchema}}
    )
...
class GetServerSecurityGroups(VsphereServerApiView):
    ...
    def get(self, controller, data, oid, *args, **kwargs):
        ...
        resp = {
            "server_security_groups": [i.small_info() for i in res],
            "count": len(res),
        }
        return resp
...
class GetServerHtml5Console(VsphereServerApiView):
    ...
    responses = {200: {"description": "return html5 console page"}}
