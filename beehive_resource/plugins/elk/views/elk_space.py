...
class ListElkSpaces(ElkSpaceView):
    ...
    responses = SwaggerApiView.setResponses({
        200: {
            'description': 'success',
            'schema': ListElkSpacesResponseSchema
        }
    })
...
class GetElkSpace(ElkSpaceView):
    ...
    responses = SwaggerApiView.setResponses({
        200: {
            'description': 'success',
            'schema': GetElkSpaceResponseSchema
        }
    })
...
class UpdateElkSpaceParamRequestSchema(UpdateProviderResourceRequestSchema):
    spaces = fields.Nested(UpdateElkSpaceTemplateRequestSchema, required=False, many=True,
                             description='list of orchestrator spaces to link', allow_none=True)
