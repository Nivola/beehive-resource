...
class ListElkRoleMappingsResponseSchema(PaginatedResponseSchema):
    role_mappings = fields.Nested(ListElkRoleMappingsParamsResponseSchema, many=True, required=True, allow_none=True)
...
class ListElkRoleMappings(ElkRoleMappingView):
    ...
    responses = SwaggerApiView.setResponses({
        200: {
            'description': 'success',
            'schema': ListElkRoleMappingsResponseSchema
        }
    })
...
class GetElkRoleMapping(ElkRoleMappingView):
    ...
    responses = SwaggerApiView.setResponses({
        200: {
            'description': 'success',
            'schema': GetElkRoleMappingResponseSchema
        }
    })
...
class CreateElkRoleMappingParamRequestSchema(CreateProviderResourceRequestSchema):
    ...
    name = fields.String(required=True, example='Test role_mapping', default='', description='RoleMapping name')
    desc = fields.String(example='This is the test role_mapping', default='', description='RoleMapping description')
...
class UpdateElkRoleMappingParamRequestSchema(UpdateProviderResourceRequestSchema):
    role_mappings = fields.Nested(UpdateElkRoleMappingTemplateRequestSchema, required=False, many=True,
                             description='list of orchestrator role_mappings to link', allow_none=True)
