...
class ListElkRoles(ElkRoleView):
    ...
    responses = SwaggerApiView.setResponses({
        200: {
            'description': 'success',
            'schema': ListElkRolesResponseSchema
        }
    })
...
class GetElkRole(ElkRoleView):
    ...
    responses = SwaggerApiView.setResponses({
        200: {
            'description': 'success',
            'schema': GetElkRoleResponseSchema
        }
    })
...
class UpdateElkRoleParamRequestSchema(UpdateProviderResourceRequestSchema):
    roles = fields.Nested(UpdateElkRoleTemplateRequestSchema, required=False, many=True,
                             description='list of orchestrator roles to link', allow_none=True)
