...
class ListGrafanaAlertNotificationsResponseSchema(PaginatedResponseSchema):
    alert_notifications = fields.Nested(ListGrafanaAlertNotificationsParamsResponseSchema, many=True, required=True, allow_none=True)
...
class CreateGrafanaAlertNotificationParamRequestSchema(CreateProviderResourceRequestSchema):
    ...
    name = fields.String(required=True, example='test-name-alert_notification', default='', description='AlertNotification name')
    desc = fields.String(required=False, allow_none=True, example='test-desc-alert_notification', description='The resource description')
...
class UpdateGrafanaAlertNotificationTemplateRequestSchema(Schema):
    name = fields.String(required=True, example='Test alert_notification', default='', description='AlertNotification name')
    desc = fields.String(required=False, example='This is the test alert_notification', default='', description='AlertNotification description')


class UpdateGrafanaAlertNotificationParamRequestSchema(UpdateProviderResourceRequestSchema):
    alert_notifications = fields.Nested(UpdateGrafanaAlertNotificationTemplateRequestSchema, required=False, many=True,
                             description='list of orchestrator alert_notifications to link', allow_none=True)
...
class GrafanaAlertNotificationAPI(GrafanaAPI):
    ...
    def register_api(module, **kwargs):
        ...
        rules = [
            ...
            ('%s/alert_notifications/<oid>' % base, 'GET', GetGrafanaAlertNotification, {}),
            ('%s/alert_notifications' % base, 'POST', CreateGrafanaAlertNotification, {}),
            ('%s/alert_notifications/<oid>' % base, 'PUT', UpdateGrafanaAlertNotification, {}),
            ('%s/alert_notifications/<oid>' % base, 'DELETE', DeleteGrafanaAlertNotification, {})
        ]
