...
class GrafanaContainer(Orchestrator):
    ...
    def __new_connection(self):
        ...
        try:
            ...
            self.conn_grafana = GrafanaManager(host=grafana_host, hosts=grafana_hosts, port=grafana_port, protocol=grafana_protocol, username=grafana_user, pwd=grafana_pwd)
