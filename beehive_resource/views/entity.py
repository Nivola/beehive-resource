...
from beehive.common.apimanager import ApiView, ApiObjectSmallResponseSchema, ApiObjectResponseSchema, \
    PaginatedRequestQuerySchema, PaginatedResponseSchema, SwaggerApiView, ApiObjecCountResponseSchema, \
    GetApiObjectRequestSchema, ApiObjectPermsRequestSchema, ApiObjectPermsResponseSchema, CrudApiObjectResponseSchema, \
    CrudApiObjectTaskResponseSchema, CrudApiObjectSimpleResponseSchema
...
class GetResourceErrors(ResourceApiView):
    ...
    responses = SwaggerApiView.setResponses({
        200: {
            'description': 'success',
            'schema': GetResourceErrorsResponseSchema
        }
    })
